...
<!-- Tambahkan data-toggle="tooltip" dan title untuk tombol tambah foto -->
                ...
                <div class="card-body">
                    ...
                    <div class="container mt-5">
                        <div class="profile-picture-wrapper text-center">
                            ...
                            <button class="btn btn-upload btn-outline-light shadow" style="width: 30px; height: 30px;" data-toggle="modal" data-target="#uploadModal" data-toggle="tooltip" data-placement="top" title="Ubah foto">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-toggle="tooltip" title="Ganti foto">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                    ...
                    <div class="text-center mt-4">
                        <a href="admin.php" class="btn btn-primary mr-2">Kembali</a>
