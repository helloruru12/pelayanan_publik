...
<head>
    ...
    <style>
        ...
        /* Penyesuaian untuk sidebar agar tidak terlalu lebar di mobile */
        @media (max-width: 768px) {
            ...
            .sidebar:not(.toggled) {
                width: var(--sidebar-width) !important; /* Sesuaikan jika Anda punya variabel ini */
                min-width: 10rem; /* Contoh lebar minimal */
            }
        }
    </style>
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php echo (!isset($_GET['url']) || $_GET['url'] == 'dashboard') ? 'active' : ''; ?>">
            ...
            <li class="nav-item <?php echo (isset($_GET['url']) && $_GET['url'] == 'tulis-pengaduan') ? 'active' : ''; ?>">
                <a class="nav-link" href="?url=tulis-pengaduan">
                    <i class="fas fa-fw fa-edit"></i>
                    <span>Tulis Laporan</span></a>
            </li>

            <li class="nav-item <?php echo (isset($_GET['url']) && $_GET['url'] == 'lihat-pengaduan') ? 'active' : ''; ?>">
    ...
    <script>
        // No custom script for sidebar toggle needed, sb-admin-2.js handles it.
        // The previous custom script for #sidebarToggleTop is replaced by SB Admin 2's built-in functionality.
    </script>
