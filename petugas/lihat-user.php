                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" data-toggle="modal" data-target="#modalFotoUser<?= $data['nik']; ?>">
                                    <img src="../profil/<?= $data['foto']?>" class="img-thumbnail rounded shadow-sm" style="width: 75px;">
                                </a>
                            </td>
                            <td>
                                <!-- Tombol Edit -->
                                <a href="edit-user.php?nik=<?= $data['nik'] ?>" class="btn btn-sm btn-outline-primary rounded-pill shadow-sm w-100 mb-1 text-sm">
                            ...
                            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body bg-light text-center">
                                        <img src="../profil/<?= $data['foto']; ?>" class="img-fluid rounded shadow-sm">
                                    </div>
                                </div>
                            </div>
                        </div>
