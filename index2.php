...
<body>
      ...
      <div class="card-body">
        ...
        <form class="user" method="post" action="proses-login2.php">
          <div class="form-group">
            <input name="username" type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Masukkan Username" required />
          </div>
          <div class="form-group">
          ...
          <div class="text-center links-bottom">
            <div>
              <i class="fa fa-laptop fa-fw"></i> Bukan admin? <a href="index.php">Kembali</a>
            </div>
          </div>
        </form>
      </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      setTimeout(() => {
        cardLogin.classList.add('fade-in');
      }, 100);
    });
  </script>
</body>
